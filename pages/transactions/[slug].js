...
export const getStaticPaths = createCptStaticPaths('transaction');
export const getStaticProps = createCptStaticProps('transaction');

export default function TransactionDetailPage({ post }) {
      ...
      <article className={utilStyles.headingMd}>
        ...
        {visibleFields.length > 0 && (
          <section className={utilStyles.headingMd}>
            <h2 className={utilStyles.headingLg}>Transaction Details</h2>
