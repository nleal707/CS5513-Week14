...
export const getStaticPaths = createCptStaticPaths('contact');
export const getStaticProps = createCptStaticProps('contact');

export default function ContactDetailPage({ post }) {
      ...
      <article className={utilStyles.headingMd}>
        ...
        {visibleFields.length > 0 && (
          <section className={utilStyles.headingMd}>
            <h2 className={utilStyles.headingLg}>Contact Details</h2>
